{/* <div className="main-content-container_table__main" key={index} onClick={handlerRowTableOnClick}>
    <div className="main-content-container_table__main-name">
        <span>{element.name.firstName}</span>
    </div>
    <div className="main-content-container_table__main-lastname">
        <span>{element.name.lastName}</span>
    </div>
    <div className="main-content-container_table__main-about">
        <span>{element.about}</span>
    </div>
    <div className="main-content-container_table__main-eyeColor">
        <span>{element.eyeColor}</span>
    </div>
</div> */}
...
const mainContentContainer = document.querySelector('.main-content-container_table__main');

const consistHTML = arrayJSON.map((element) => `
<div><button class="edit-button" id="${element.id}">Отредактировать</button></div>
<div class="main-content-container_table__main-name"><span>${element.name.firstName}</span> </div>
<div class="main-content-container_table__main-lastname"><span>${element.name.lastName}</span></div> 
<div class="main-content-container_table__main-about"><span>${element.about}</span></div> 
<div class="main-content-container_table__main-eyeColor"><span>${element.eyeColor}</span></div> 
`);
...
editButton.onclick = function (event) {
    ...
    findElementArray(arrayJSON, event.target.id);
}

const nameField = document.querySelector('#name');
const lastNameField = document.querySelector('#lastName');
const aboutField = document.querySelector('#about');
const eyeColorField = document.querySelector('#eyeColor');

const findElementArray = (array, id) => {
    for (let i = 0; i < array.length - 1; i++) {

        if (array[i].id === id) {
            console.log(array[i]);
            nameField.value = array[i].name.firstName;
            lastNameField.value = array[i].name.lastName;
            aboutField.value = array[i].about;
            eyeColorField.value = array[i].eyeColor;
        }
    }
}